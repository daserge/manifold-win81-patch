...
function androidExec(success, fail, service, action, args) {
    ...
    console.log('androidExec.1');

    console.log('androidExec.1: nativeApiProvider: ' + nativeApiProvider + ' nativeApiProvider.get(): ' + nativeApiProvider.get() + 
        ' bridgeSecret: ' + bridgeSecret + ' service: ' + service + ' action: ' + action + ' callbackId: ' + callbackId + 
        ' argsJson: ' + argsJson);
    var messages = nativeApiProvider.get().exec(bridgeSecret, service, action, callbackId, argsJson);
    console.log('androidExec.2: messages: ' + messages + ': ' + JSON.stringify(messages));
