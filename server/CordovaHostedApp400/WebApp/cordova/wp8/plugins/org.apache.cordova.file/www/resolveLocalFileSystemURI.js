    ...
    var success = function(entry) {
        if (entry) {
            ...
            if (successCallback) {
                ...
                //alert(JSON.stringify(fsName, null, 4));
                fileSystems.getFs(fsName, function (fs) {
                    //alert(JSON.stringify(fs, null, 4));
                    if (!fs) {
                    ...
                    //alert('result.toInternalURL()'); // it's equal to "///CapturedImagesCache/WP_20141118_008.jpg
                    //alert(JSON.stringify(result.toInternalURL(), null, 4));
